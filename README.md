...
- 🖥️ **系统托盘** - 支持最小化到托盘，实时显示监控状态
- 🤖 **AI 整理** - 支持 OpenAI 兼容 API 的智能文件分类与报告生成
- ⌨️ **快捷键支持** - 常用操作快捷键（Ctrl+F/F5/Enter/Delete 等）
- 💾 **备份恢复** - 数据库一键备份和恢复
...
| **原盘识别** | 支持蓝光BDMV/DVD ISO 原盘目录结构识别 |
...
- **目录监控**: 本功能仅建议监控文件相对稳定的目录，切勿监控包含本程序的文件目录，现阶段会因为数据频繁变动导致监控异常。
